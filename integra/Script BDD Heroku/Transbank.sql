...
--
-- Host: us-cdbr-east-05.cleardb.net    Database: heroku_6194b72a583b0b5
-- ------------------------------------------------------
...
CREATE TABLE `balance` (
  `id_bal` int(11) NOT NULL AUTO_INCREMENT,
  `balance_bal` int(11) DEFAULT NULL,
