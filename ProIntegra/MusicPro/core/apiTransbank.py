...
def getAllAccount():
    try:
        key="account"
        url="https://springboot-transbank.herokuapp.com/" + key
...
def getClient(id):
    try:
        url="https://springboot-transbank.herokuapp.com/client/"+ str(id)
        respuesta = requests.get(url)
        if respuesta.status_code == 200:
...
def getBank(id):
    try:
        url="https://springboot-transbank.herokuapp.com/bank/"+ str(id)
        respuesta = requests.get(url)
        if respuesta.status_code == 200:
            print("se logró"+ str(respuesta))
            data = respuesta.json()
...
def getAccount(id):
    try:
        url="https://springboot-transbank.herokuapp.com/account/"+ str(id)
        respuesta = requests.get(url)
        if respuesta.status_code == 200:
            print("se logró"+ str(respuesta))
            data = respuesta.json()
...
def getBalance(id):
    try:
        url="https://springboot-transbank.herokuapp.com/balance/"+ str(id)
        respuesta = requests.get(url)
        if respuesta.status_code == 200:
            print("se logró"+ str(respuesta))
            data = respuesta.json()
...
def balanceByClient(idClient):
    try:
        url="https://springboot-transbank.herokuapp.com/balancebyclient/"+ str(idClient)
        respuesta = requests.get(url)
        if respuesta.status_code == 200:
            print("se logró"+ str(respuesta))
            data = respuesta.json()
